...
- [Удаление моментальных снимков с истекшим жизненным циклом](#Удаление-моментальных-снимков-с-истекшим-жизненным-циклом)

- [Создадим триггеры таймеры](#Создадим-триггеры-таймеры)
...
- [Просмотр моментальных снимков](#Просмотр-моментальных-снимков)
...
- Удаление снимков выполняется ежедневно в 12:00.
